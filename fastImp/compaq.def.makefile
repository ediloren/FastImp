#const static char cvsid[] = "$Id: compaq.def.makefile,v 1.2 2003/07/22 21:43:18 zhzhu Exp $";
...
# and put the instatiation of templates there. The final link will also
# use this subdirectory. This is not the case 
...
PFFT_ROOT =  $(HOME)/fastimpRelease/pfft++
