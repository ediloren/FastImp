...
/* $Id: executor.c,v 1.1.1.1 2002/03/12 20:08:56 zhzhu Exp $ */
#include <fftw-int.h>
#include <stdio.h>
#include <stdlib.h>

const char *fftw_version = "FFTW V" FFTW_VERSION " ($Id: executor.c,v 1.1.1.1 2002/03/12 20:08:56 zhzhu Exp $)";
